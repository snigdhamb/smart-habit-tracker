    ...
    >
      <Flex direction={['column', 'column', 'row']} w="100%" h="100%">
        <Box flex="1" p={6} display="flex" flexDirection="column" justifyContent="center" alignItems="center">
          <Center mb={10}>
            <Box alignSelf="flex-start" animation={`${fadeIn} 1.2s ease-out`}  opacity={0} animationFillMode="forwards">
              <Image src={Logo} alt="App Logo" boxSize="300px" objectFit="contain" />
            </Box>
          </Center>
          <Center mb={10}>
            <Box animation={`${fadeIn} 1.2s ease-out`} opacity={0} animationFillMode="forwards">
        ...
        <Box flex="1" p={6} display="flex" flexDirection="column" justifyContent="center" alignItems="left">
          <Card.Root size="sm" w="80%" mb={5} boxShadow="md" animation={`${slideIn} 1s ease-out`} opacity={0} animationFillMode="forwards" animationDelay="0.4s">
            <Card.Header>
          ...
          <Card.Root size="sm" w="80%" mb={5} boxShadow="md" animation={`${slideIn} 1s ease-out`} opacity={0} animationFillMode="forwards" animationDelay="0.8s">
            <Card.Header>
          ...
          <Card.Root size="sm" w="80%" mb={5} boxShadow="md" animation={`${slideIn} 1s ease-out`} opacity={0} animationFillMode="forwards" animationDelay="1.2s">
            <Card.Header>
